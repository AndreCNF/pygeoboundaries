...
def get_state_boundaries(
    country: str, state: str, adm: str = "ADM1"
) -> gpd.GeoDataFrame:
    """
    ...
    Returns:
        gpd.GeoDataFrame: the GeoDataFrame containing the boundaries
    """
    ...
    adm_gdf.sort_values("state_name_similarity", ascending=False, inplace=True)
    return adm_gdf.head(1)
